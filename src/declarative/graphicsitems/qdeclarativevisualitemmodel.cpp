...
{
    return QDeclarativeListProperty<QDeclarativeVisualModel>(this, this, this->model_append,
                                                      this->model_count, this->model_at);
}
...
void QDeclarativeVisualModels::onCreatedItem(int index, QDeclarativeItem *item)
{
    ...
    index = findAbsoluteIndex(model, index);
...
{
    QDeclarativeVisualModel *model = static_cast<QDeclarativeVisualModel *>(sender());
    from = findAbsoluteIndex(model, from);
    to = findAbsoluteIndex(model, to);
    emit itemsMoved(from, to, count);
}
...
int QDeclarativeVisualModels::findAbsoluteIndex(QDeclarativeVisualModel *model, int index)
{
